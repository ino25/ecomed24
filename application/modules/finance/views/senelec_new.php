...
<section id="main-content">
    <section class="wrapper site-min-height">
        <div class="top-nav">
            <code id="success" style="display:none" class="flashmessage pull-right"> Paiement Senelec effectué avec succès</code>                
        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="cacherBouton">
                                        <div class="form-group col-md-12" style="padding-top:20px">
                                            <button onclick="validationSenelec()" name="submit" class="btn btn-info pull-right"><?php echo lang('submit_effectuer'); ?></button>
                                    ...
                                    <div class="col-md-12">
                                         <code id="errorSenelec" class="flash_message" style="display:none"></code>        
                                    </div>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="adv-table editable-table ">
                        <div class="space15"></div>
                            <table class="table table-hover progress-table text-center">
                                <thead>
                                    <tr>
                                        <th><?php echo lang('reference_client_senelec'); ?></th>
...
<script type="text/javascript">
  $(document).ready(function () {
   ...
   $("#submit").click(function (e) {
    ...
    if(nbreCustomerReference < 10 || nbreCustomerReference > 13){
            compteurID.style['display'] = 'block';
        }
        else{
            var reponseAll =  invoiceSenelec("fr",customerReference,formCustmer,pin);
