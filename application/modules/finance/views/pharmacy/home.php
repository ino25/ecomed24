    ...
    <section class="wrapper site-min-height">           
        ...
        <div class="col-md-12">
            ...
            <div class="row state-overview">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'adminmedecin'))) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                ...
                                <h1 class="">
                                    <?php echo number_format($today_sales_amount, 0, '.', '.') ; ?> FCFA
                                </h1>
                            </div>
                        </section>
                        <?php if ($this->ion_auth->in_group(array('admin', 'adminmedecin'))) { ?>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'adminmedecin'))) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                ...
                                <h1 class="">
                                    <?php echo number_format($today_expenses_amount, 0, '.', '.'); ?> FCFA
                                </h1>
                ...
                <?php if ($this->ion_auth->in_group(array('admin','adminmedecin', 'Pharmacist'))) { ?>
                            ...
                            <table class="table table-hover progress-table text-center" id="">
                                ...
                                foreach ($payments as $payment) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php echo number_format($payment->gross_total, 0, '.', '.'); ?> FCFA</td>
                                    </tr>
                                    <?php
                                    if ($i == 10)
                                        break;
                        ...
                        <table class="table table-hover progress-table text-center" id="">
                            ...
                            foreach ($latest_medicines as $latest_medicine) {
                                ...
                                <tr class="">
                                    ...
                                    <td><?php echo number_format($latest_medicine->s_price, 0, '.', '.'); ?> FCFA</td>
                                </tr>
                                <?php
                                if ($i == 10)
                                    break;
...
<script type="text/javascript">
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            ['Aoû', <?php echo $this_year['payment_per_month']['august']; ?>, <?php echo $this_year['expense_per_month']['august']; ?>],
