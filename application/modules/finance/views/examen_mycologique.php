                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                        ...
                        if (tabDetails[ii]) {
                            ...
                            /*addedHtml += "<tr>";
                             ...
                             addedHtml += "</tr>";
                             */
                            if (prestas[1] === 'Macroconidie') {
                                addedHtml2 += "<h4>Examen direct :</h4>";
                            ...
                            if (prestas[1] === 'Levures') {
                                ...
                                addedHtml2 += '</div>';
                                addedHtml2 += '</br>';
                                addedHtml2 += "<h4>Culture :</h4>";
                            }
                            if (prestas[1] === 'Isolement') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-8 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Candida albicans">Candida albicans</option>';
                                addedHtml2 += '<option value="Candida spp">Candida spp</option>';
                                addedHtml2 += '<option value="Chrysosporium keratinophylum">Chrysosporium keratinophylum</option>';
                                addedHtml2 += '<option value="En cours+">En cours+</option>';
                                addedHtml2 += '<option value="Levures filamenteuses">Levures filamenteuses</option>';
                                addedHtml2 += '<option value="Microsporum langeronii">Microsporum langeronii</option>';
                                addedHtml2 += '<option value="Négatif">Négatif</option>';
                                addedHtml2 += '<option value="Non effectuée">Non effectuée</option>';
                                addedHtml2 += '<option value="Positif">Positif</option>';
                                addedHtml2 += '<option value="Positif à levures">Positif à levures</option>';
                                addedHtml2 += '<option value="Positif à levures sur onychomycose">Positif à levures sur onychomycose</option>';
                                addedHtml2 += '<option value="Positif à T. verrucosum">Positif à T. verrucosum</option>';
                                addedHtml2 += '<option value="Rhodotorula rubra">Rhodotorula rubra</option>';
                                addedHtml2 += '<option value="Trichophyton rubrun">Trichophyton rubrun</option>';
                                addedHtml2 += '<option value="Trichophyton soudanense">Trichophyton soudanense</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += '</div>';
                            }
                            ...
                            if (prestas[1] === 'Conclusion') {
                                addedHtml2 += '<div class="col-md-8 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<textarea rows='6' cols='100' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\">Recherche de champignons pathogènes spécifiques négative.</textarea>";
                                addedHtml2 += "</div>";
                            }
