        ...
        <div class="col-md-12">
            <div class="row state-overview" style="padding: 23px 0px;">
                <div class="col-md-8">
                    ...
                    <div class="panel-heading">Recettes par jour (<?php echo $current_month.' '.date('Y', $first_minute); ?>) 
                    ...
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-hover progress-table text-center" id="editable-sample1">
                                <thead>
                                    <tr>
                                        <th style="text-align:center;"> <?php echo lang('date'); ?> </th>
                                ...
                                <tbody>
                                    ...
                                    for ($d = 1; $d <= $number_of_days; $d++) {
                                        ...
                                        if (!empty($all_payments[date('D d-m-y', $time)])) {
                                            if (date('m', $time) == $month) {
                                                $day = date('d/m/yy', $time);
                                                $datesJour = $joursem[date("w",$time)];
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $datesJour.' '.$day; ?></td>
                                            <td><?php echo number_format($amount, 0, '.', '.'); ?> FCFA</td>
                                    ...
                                    <tr style="color: #000 !important; font-weight: bold;">
                                        ...
                                        <td><?php echo number_format($total_amount, 0, '.', '.'); ?> FCFA</td>
                                    </tr>
...
<script type="text/javascript">
    ...
    function drawVisualization() {
        ...
        var income = '<?php echo lang('payment'); ?>';
