        ...
        <section class="">
            <header class="panel-heading" style="margin-top:41px;">
                <h2>
                    ...
                    $partenairelight = '';
                    if (isset($_GET['partenairelightcheck'])) {
                        $partenairelight = $_GET['partenairelightcheck'];
                    }
                    $idpartenairelightcheck = '';
                    if (isset($_GET['idpartenairelightcheck'])) {
                        $idpartenairelightcheck = $_GET['idpartenairelightcheck'];
                    }
                    ?>
                </h2>
            </header>
                                    ...
                                    <form role="form" id="editPaymentForm" class="clearfix" action="finance/addPayment" method="post" enctype="multipart/form-data">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12 payment pad_bot liste_partenaire_light " id="liste_partenaire_light" style="display: none">
                                                <label for="exampleInputEmail1"> <?php echo lang('partenaire'); ?></label>
                                                <input type="hidden" class="form-control" value="<?php echo $idpartenairelightcheck ?>" readonly />
                                                <input id="partenairelightcheck" type="hidden" class="form-control" value="<?php echo $partenairelight ?>" readonly />
                                                <!-- <?php if ($idpartenairelightcheck) { ?>
                                                    <input type="text" class="form-control" value="<?php echo $partenairelight ?>" readonly />
                                                    <input type="hidden" class="form-control" value="<?php echo $idpartenairelightcheck ?>" id="lightpartenaire" name="lightpartenaire"/>
                                                    <input type="hidden" class="form-control" value="<?php echo $idpartenairelightcheck ?>" id="checklight"/>
                                                    

                                                <?php } else { ?>
                                                    <select class="form-control m-bot15 lightpartenaire" id="lightpartenaire" name="lightpartenaire" required="">
                                                    </select>
                                                <?php  } ?> -->
                                                <input type="hidden" class="form-control" value="<?php echo $idpartenairelightcheck ?>" id="checklight"/>
                                                <select class="form-control m-bot15 lightpartenaire" id="lightpartenaire" name="lightpartenaire">
                                                    </select>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div class="info-mutuelle" style="margin:15px 0px;text-align: center;border: 2px solid rgba(0,0,0,0.4)"></div>
                                            </div>
                                            <style>
                                                .qfloww {
                                            ...
                                            <div class="col-md-12" style="display: flex;">
                                                <div style="flex: 4; margin-right: 15px;" class="col-md-34  payment">
                                                ...
                                                <div style="flex: 8" class="col-md-54 qfloww left0" style="margin: 0px 15px;" id="qfloww">
                                                    <label class=" col-md-4 remove1_ remove pull-left"><?php echo lang('procedures') ?></label>
                                                ...
                                                <div style="flex: 4; margin-left: 15px;" class="col-md-44 thumbnail">
                                                    <div class="col-md-12-">
                                                        <div class="col-md-12- right-six-">
                                                            ...
                                                            <div id="patientTestCovid" style="display:none">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <label for="exampleInputEmail1">MOTIF DU DÉPISTAGE</label>
                                                                    <input type="text" class="form-control" name="motifVoyage" id="motifVoyage" value='' placeholder="Motif du dépistage">
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <div class="form-group cashsubmit payment  right-six col-md-12" id="bouttonSuivant">
                                                ...
                                                <div class="col-md-3">
                                                    <?php if ($page == 'patient') { ?>
                                                        <a href="patient/medicalHistory?id=<?php echo $patient_id; ?>&type=payment" class="btn btn-info btn-secondary pull-right" data-dismiss="modal" aria-hidden="true"> <?php echo lang('close'); ?></a>
                                                    <?php } else if ($page == 'historique') { ?>
                                                        <a href="finance/patientPaymentHistory?patient=<?php echo $patient_id; ?>" class="btn btn-info btn-secondary pull-right" data-dismiss="modal" aria-hidden="true"> <?php echo lang('close'); ?></a>

                                                    <?php } else { ?>
                                                        <a href="finance/payment" class="btn btn-info btn-secondary pull-right" data-dismiss="modal" aria-hidden="true"> <?php echo lang('close'); ?></a>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-md-3">
                                                    <button type="submit" name="submit2" id="submit1" onclick=envoyer() class="btn btn-info row pull-left"> <?php echo lang('submit'); ?></button>
                                                </div>
                                                <div class="col-md-3"></div>
                ...
                <form role="form" class="clearfix" action="javascript:void(0);" method="post" id="passport_info" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form_control type_pf js-example-basic-single" name="" required="" value=" ">
                            ...
                            <?php foreach ($type_of_purpose as $type_purpose) { ?> <option value="<?php if ($type_purpose->name) {
                                                                                                        echo $type_purpose->id;
                                                                                                    } ?>"><?php if ($type_purpose->name) {
                                                                                                                echo $type_purpose->name;
                                                                                                            } ?></option><?php } ?>
...
\n\<label class=" col-md-1 remove pull-right"></label></div>\n\
    ...
    $(document).ready(function() {
        ...
        document.getElementById('redirectLight').value = 'finance/addPaymentView';
