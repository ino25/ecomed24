        ...
        <form role="form" id="editLabForm" class="clearfix" action="lab/addLabNewPayment" method="post" enctype="multipart/form-data">
            ...
            <section class="panel col-md-12 no-print">
                ...
                <div class="col-md-12 lab pad_bot" id="report_group">
                    ...
                    <div class="col-md-11">
                        <textarea class="ckeditor form-control" name="resultats[]" value="" rows="10"><?php
                                                                                                        if (!empty($setval)) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                addedHtml += "<input type='hidden' id='prestations' name='prestations' value=\"" + idPrestation + "\" /> </div>";
                ...
                for (ii = 0; ii < tabDetails.length; ii++) {
                    ...
                    if (tabDetails[ii]) {
                        ...
                        /*addedHtml += "<tr>";
                         ...
                         addedHtml += "</tr>";
                         */
                        //addedHtml += "<div><input class='form-control shadow' type='text'  /></div>";
                        addedHtml += "<div><input class='form-control shadow'readonly  type='hidden' id='' name='' value=\"" + prestas[2] + "\" /></div>";
                        addedHtml += "<div><input class='form-control shadow' readonly  type='hidden'  id='' name='' value=\"" + prestas[3] + "\" placeholder='' /></div>";
