                    ...
                    <table class="table table-hover progress-table" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th style="width:0%">&nbsp;</th>
                                <!--<th style="">Type</th>-->
                                <th style="width:10%;">PAF (Paie à ses frais)</th>
                                <th style="width:10%;"><?php echo lang('price2'); ?> Privé</th>
                                <th style="width:10%;"><?php echo lang('price2'); ?> Public</th>
						...
						<div class="col-md-12">							
							...
							<div class="col-md-12">		
								...
								<div class="form-group  col-md-3">
									<label for="exampleInputEmail1">PAF (Paie à ses frais)</label>
									<input type="text" class="form-control money" name="tarif_public" id="tarif_public" required value='' placeholder="">
								</div>	
								<div class="form-group  col-md-3">
									<label for="exampleInputEmail1"><?php echo lang('price2'); ?> Public</label>
									<input type="text" class="form-control money" name="prix_public" id="prix_public" value='' placeholder="">
								</div>
                                <div class="form-group  col-md-3">
								...
								<div class="form-group  col-md-3">
									...
									<input type="text" class="form-control money" name="tarif_assurance" id="tarif_assurance" value='' placeholder="" disabled>
								</div>
								 <div class="form-group  col-md-3">
									<label for="exampleInputEmail1"><?php echo lang('price2'); ?> <?php echo lang('ipm'); ?></label>
									<input type="text" class="form-control money" name="tarif_ipm" id="tarif_ipm" value='' placeholder="" disabled>
								</div>
                             </div>
...
function editPrices(idpco) {
	...
	$.ajax({
	  ...
	  if(response.details) {
            ...
            const element5 = AutoNumeric.getAutoNumericElement('#prix_public');
			element5.set(response.details.prix_public);
