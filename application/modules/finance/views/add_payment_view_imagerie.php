                        ...
                        <div class="">
                            ...
                            <section class="">
                                ...
                                <div class="">
                                    ...
                                    <input type="hidden" class="form-control pay_in" name="consultation"  value='2'>
                                    <input type="hidden" class="form-control pay_in" name="nameHeader"  value="IMAGERIE MÉDICALE">
                                        ...
                                        <div class="col-md-12 thumbnail row">
                                            ...
                                            <div class="col-md-9 qfloww left0" id="qfloww">
                                                <label class=" col-md-10 remove1_">SERVICES > PRESTATIONS </label>
...
<script src="<?php echo base_url(); ?>common/js/paiementImagerie.js?<?php echo time(); ?>"></script>
