                                ...
                                <tbody>
                                    ...
                                    if (!empty($payment->category_name)) {
                                        ...
                                        foreach ($category_name1 as $category_name2) {
                                            ...
                                            if ($category_name3[3] > 0 && $category_name3[1]) {
                                                ...
                                                $idPrestation = isset($category_name3[0]);
                                                $data['nomPrestation'] = $this->finance_model->getPaymentcategoryById($category_name3[0]);
                                                $data['nomSpecialite'] = $this->lab_model->getLabTestImportedById($category_name3[0]);
                                                $namePrestation = isset($data['nomPrestation']->prestation) && $data['nomPrestation']->prestation != null ? $data['nomPrestation']->prestation : "";
                                                $nameSpecialite = isset($data['nomSpecialite']->name) && $data['nomSpecialite']->name != null ? $data['nomSpecialite']->name : "";
                                    ...
                                    ?>
                                                ...
                                                <tr class="ligneFacture">
                                                    ...
                                                    <td class="col-4 border-0" style="width: 40%;"><span class="prestationFacture"><?php if (isset($category_name3[5]) == 'service') { ?><?php echo $namePrestation; ?><?php
                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                        echo $namePrestation;
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                        ?></span></td>
                                                    ...
                                                    <td class="no-print" style="padding-top:2px;">
                                                        ...
                                                        if (isset($category_name3[5]) == 'service') {
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" class="bg-light-2 text-right"> <?php echo number_format($payment->hospital_amount, 0, ",", "."); ?> <?php echo $settings->currency; ?>
                                                <input hidden type="text" id="tPartiel" value="<?php echo number_format($payment->hospital_amount, 0, ",", "."); ?> <?php echo $settings->currency; ?>">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" class="bg-light-2 text-right"> <?php if (!empty($payment->frais_service)) {
                                                                                                $g = intval($payment->hospital_amount + $payment->frais_service) - intval($payment->charge_mutuelle);
                                                                                                echo number_format($g, 0, ",", "."); ?> <?php echo $settings->currency;
                                                                                                                                    } else {
                                                                                                                                        $g = intval($payment->hospital_amount)  - intval($payment->charge_mutuelle);
                                                                                                                                        echo number_format($g, 0, ",", "."); ?> <?php echo $settings->currency;
                                                                                                                                    } ?>
