                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                        ...
                        if (tabDetails[ii]) {
                            ...
                            if (prestas[1] === 'Odeur') {
                                ...
                                addedHtml2 += '<option value="Inodores">Inodores</option>';
                                addedHtml2 += '<option value="Fétides">Fétides</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                            }
                            if (prestas[1] === 'Couleurs') {
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Blanchâtres">Blanchâtres</option>';
                                addedHtml2 += '<option value="Grisâtres">Grisâtres</option>';
                                addedHtml2 += '<option value="Verdâtres">Verdâtres</option>';
                                addedHtml2 += '<option value="Brunâtres">Brunâtres</option>';
                                addedHtml2 += '<option value="Hématiques">Hématiques</option>';
                                addedHtml2 += '<option value="Jaunâtres">Jaunâtres</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += "</div>";
                                addedHtml2 += "</br>";
                            }
                            if (prestas[1] === 'Aspect des leucorrhées') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Homogènes">Homogènes</option>';
                                addedHtml2 += '<option value="Mousseuses">Mousseuses</option>';
                                addedHtml2 += '<option value="Adhérentes">Adhérentes</option>';
                                addedHtml2 += '<option value="striées de sang">striées de sang</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                            }
                            if (prestas[1] === 'Consistance') {
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Epaisses">Epaisses</option>';
                                addedHtml2 += '<option value="Fluides">Fluides</option>';
                                addedHtml2 += '<option value="Glaireuses">Glaireuses</option>';
                                addedHtml2 += '<option value="Laiteuses">Laiteuses</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += "</div>";
                                addedHtml2 += "</br>";
                            ...
                            if (prestas[1] === 'Flore bactérienne') {
                                ...
                                addedHtml2 += '<option value="Rare">Rare</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                            }
                            if (prestas[1] === 'Type de flore /SN') {
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Type I">Type I</option>';
                                addedHtml2 += '<option value="Type II">Type II</option>';
                                addedHtml2 += '<option value="Flore assez riche">Flore assez riche</option>';
                                addedHtml2 += '<option value="Type II + Bacilles à Gram+">Type II + Bacilles à Gram+</option>';
                                addedHtml2 += '<option value="Type III + Bacilles à Gram +">Type III + Bacilles à Gram +</option>';
                                addedHtml2 += '<option value="Type III">Type III</option>';
                                addedHtml2 += '<option value="Type IV">Type IV</option>';
                                addedHtml2 += '<option value="Type IV + Bacilles à Gram +">Type IV + Bacilles à Gram +</option>';
                                addedHtml2 += '<option value="Gardnerella vaginalis">Gardnerella vaginalis</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += "</div>";
                            }
                            ...
                            if (prestas[1] === 'Trichomonas vaginalis') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                            ...
                            if (prestas[1] === 'Gardnerella vaginalis') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                            ...
                            if (prestas[1] === 'Bacilles de Doderlein') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                            ...
                            if (prestas[1] === 'Mobiluncus spp') {
                                ...
                                addedHtml2 += "</div>";
                                addedHtml2 += '<br>';
                                addedHtml2 += '<h4>Culture systémique</h4>';
                            }
                            if (prestas[1] === 'Germes isolés') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-8 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Absence de germes">Absence de germes</option>';
                                addedHtml2 += '<option value="Présence de Candida">Présence de Candida</option>';
                                addedHtml2 += '<option value="Présence de Neisseria gonorrhoeae">Présence de Neisseria gonorrhoeae</option>';
                                addedHtml2 += '<option value="Gardnerella vaginalis">Gardnerella vaginalis</option>';
                                addedHtml2 += '<option value="Ureaplasma urealyticum">Ureaplasma urealyticum</option>';
                                addedHtml2 += '<option value="Présence de Gardnerella vaginalis et de Candida albicans">Présence de Gardnerella vaginalis et de Candida albicans</option>';
                                addedHtml2 += '<option value="Mycoplasme hominis">Mycoplasme hominis</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += "</div>";
                                addedHtml2 += '</br>';

                                addedHtml2 += '<h4>Recherche spécifique</h4>';
                            }
                            if (prestas[1] === 'Chlamydiae trachomatis') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                            ...
                            if (prestas[1] === 'Mycoplasma hominis') {
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                            ...
                            if (prestas[1] === 'Ureaplasma  urealyticum') {
                                addedHtml2 += "<div class='row'>";
                                addedHtml2 += "<div class='col-md-6 lab pad_bot'>";
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                            ...
                            if (prestas[1] === 'Conclusion') {
                                addedHtml2 += '<div class="col-md-8 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<textarea rows='6' cols='100' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\">Recherche de germes pathogènes négative, Absence d'infection vaginale, Vaginose bactérienne à Gardnerella vaginalis., Flore vaginale déséquilibrée de type III, Candidose vaginale à Candida albicans, Vaginose bacterienne à Gardnerella vaginalis et Mycoplasmes Ureaplama urealyticum., Vaginose bacterienne à Gardnerella vaginalis associée à une candidose vaginale à Candida albicans, Infection vaginal à Staphylococcus aureus</textarea>";
                                addedHtml2 += "</div>";
                            }
