                                ...
                                <div class="adv-table editable-table">
                                    <div class="clearfix">
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input class="form-control money" type="text" name="amount" id="amount"  value="" placeholder="" required autocompleted="off">
                                                ...
                                                <tr>
                                                    <th style="width: 50%;">
                                                        <div class="radio disabled">
                                                            <label><input type="radio" id="cartebancaire" name="choix" value="cartebancaire" disabled><strong class="grandeligne">Carte Bancaire (Visa/Master Card)</strong></label>
                                                        </div>
                                                    </th>
                                                    <th style="width: 50%;">
...
<script  src="<?php echo base_url()?>common/js/CommonFunctionFresh.js?<?php echo time(); ?>"></script>
...
<script>
	...
	// "toolbar=no,scrollbars=yes,location=no,statusbar=no,menubar=no,resizable=no,width="+w+",height="+h+",left = 0,top = 0");
	  ...
	  // }); // on
        ...
        $.ajax({
            url: 'depot/confirmationorangemoney?amount=' + amount + '&phone=' + phoneFormat + '&type=' + type + '&description=' + description + '&statut=' + statut + '&destinataire=' + destinataire + '&reference=' + mobRef + '&idtransaction=' + idtransaction,
            method: 'POST',
            data: '',
            dataType: 'json',
