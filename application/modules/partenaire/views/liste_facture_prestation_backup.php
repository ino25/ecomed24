...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel"  id="sectionSearchPartenaire"  style="display:block">
            ...
            <div class="">
                <form role="form" action="#" method="post" class="clearfix" enctype="multipart/form-data">
                    ...
                    <div class="col-md-2 panel">
                        ...
                        <button id="searchPartenaire" name="submit" type="submit" class="btn btn-info form-control"> <?php echo lang('search'); ?></button>
                    </div>
                    <div class="">
            ...
            <div class="panel-body panel-bodyAlt">
                <div id="confirmFactureDiv" style="display: none" class="col-md-2">  <button id="confirmFacture" class="btn btn-info form-control">Facturer</button> </div>
        ...
        <section id="sectionConfirmPartenaire" style="display:none">
