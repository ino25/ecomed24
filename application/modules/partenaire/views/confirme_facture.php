<section id="main-content">
  ...
  <?php } ?>
                ...
                <table class="table table-hover progress-table text-center editable-sample editable-sample-paiement" id="editable-sample-">
                        ...
                        <tbody>
                         <?php  foreach ($id as $value) { ?> <input type="hidden" name="id[]" value="<?php echo $value; ?>" >   <?php } ?>
                         <?php
                         $total=0;
                            ...
                            <?php if (!empty($origins->category_name)) {
                                ...
                                foreach ($category_name1 as $category_name2) {
                                    ...
                                    if ($category_name3[3] > 0 && $category_name3[1]) { 
                                        // $prix = $this->finance_model->getPaymentcategoryById($category_name3[0])->tarif_professionnel;
                                        ...
                                        <tr>
                                          <td> <?php echo $i; ?> </td>
                                           ...
                                           <td class=""> <?php  echo number_format($prix, 0, ",", ".").' '. $settings->currency; ?></td>
                                        </tr>
                                    <?php 
                    ...
                    <div class="col-md-12 hr_border">
                     ...
                     <button type="submit" name="submit"  class="btn btn-info pull-right" id="add" > <?php echo lang('send'); ?> à <?php echo $destinatairs->nom; ?></button>
