...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="col-md-9 no-print" style="display:none">
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <select class="form-control m-bot15 pos_select" id="pos_select" name="patient" value=''> 
                                         <?php if (!empty($lab_single->patient)) { ?>
                                            <option value="<?php echo $patients->id; ?>" selected="selected"><?php echo $patients->name.' '.$patients->last_name; ?> - <?php echo $patients->phone; ?></option>  
                                        <?php } ?>
                                    </select>
                                </div> 
        ...
        <section class="col-md-12">
            <header class="panel-heading" style="margin-top:41px;">
                ...
                <h2><?php echo lang('list_reports_analyse'); ?></h2>
            </header>
                    ...
                    <table class="table table-hover progress-table" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th>Analyses</th>
                                <th><?php echo lang('numero_demandeur'); ?></th>
                                <th><?php echo lang('demandeur'); ?></th>
