        ...
        <form role="form" id="editLabForm" class="clearfix" action="finance/editStatutPaiementByJasonValid" method="post" enctype="multipart/form-data">
            ...
            <section class="panel col-md-12 no-print">
                ...
                <div class="col-md-12 lab pad_bot" id="report_group">
                    ...
                    <div>
                        <h4><?php echo $prestations->prestation ?></h4>
                    </div>
                    <div class="col-md-11">
        ...
        success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                if (details) {
                    ...
                    addedHtml += "<input type='hidden' id='prestations_" + idPaymentConcatRelevantCategoryPart + "' name='prestations[]' value=\"" + codePayment + "\" />";
                    // addedHtml += "<td></td>";
                    // addedHtml += "<td></td>";
                    // addedHtml += "<td></td>";
                    // addedHtml += "</tr>";
