        ...
        <section class="">
            <header class="panel-heading">
                ...
                <?php echo lang('lab_test'); ?> 
                 <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Biologiste','adminmedecin'))) { ?>
                    <div class="col-md-4 no-print pull-right"> 
                        <a  href="lab/addLabTestMasterView?request=request">
                            <div class="btn-group pull-right">
                                <button id="" class="btn green btn-xs">
                                    <i class="fa fa-plus-circle"></i> <?php echo lang('request') . ' ' . lang('lab_test'); ?>
                                </button>
                            </div>
                        </a>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editLabTestForm" class="clearfix" action="lab/importLabTest" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="laboratorist_id" value="<?php echo $laboratorist_id ?>">
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".table").on("click", ".load", function () {
            ...
            $('#editLabTestForm').find('[name="imported_id"]').val(iid).end()
        });
    });
</script>
<script>
