            ...
            <div class="panel panel-primary" id="invoice">
                ...
                <main>
                                ...
                                ?>
                                        <tr class="ligneFacture">
                                            ...
                                            ?>
                                                ...
                                                <td class="col-4 border-0" style="width: 35%;"><strong><span class="prestationFacture">NÉGATIVE</span> </strong>
                                                </td>
                                            <?php } ?>
                                        </tr>
                                <?php
                    ...
                    <div class="col-md-12 pull-right">
                        <img class="sign_class pull-right imgy" src="<?php echo $user_signature; ?>" width="150" height="150" alt="alt" /><br>
                        <input type="hidden" id="signature" value="<?php echo $user_signature; ?>">
                    </div>
