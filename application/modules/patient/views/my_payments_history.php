        ...
        <section class="no-print col-md-8">
            ...
            <div class=" panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-hover progress-table text-center" id="editable-samples">
                        <thead>
                            <tr>
                ...
                <section class="m_t">
                    <div class="panel-body profile">
                        <div class="task-thumb-details">
                            <?php echo lang('patient'); ?> <?php echo lang('name'); ?>: <h1><a href="#"><?php echo $patient->name.' '.$patient->last_name; ?></a></h1> <br>
