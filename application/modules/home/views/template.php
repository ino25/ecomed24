        ...
        <section class="panel">
         <div class="col-md-11"> 
            <header class="panel-heading">
                 <?php echo lang('modele_laboratoire'); ?>
                <div class="col-md-11 no-print pull-right"> 
                    <a href="home/addTemplateView">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-hover progress-table text-center" id="editable-sample">
                        <thead>
                            <tr>
                                <th class="pull-left"><?php echo lang('modele').' '; ?><span style="margin-left:15px"></span></th>
                        ...
                        <tbody>
                            <?php foreach ($templates as $template){ ?>
                                <tr class="">
                                    <td class="pull-left"> <?php echo $template->name; ?></td>
                                    <td class="no-print">
                                        <a href="home/editTemplate?id=<?php echo $template->id;?>" class="btn btn-info btn-xs btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $template->id; ?>"><i class="fa fa-edit"> </i></a>   
                                    </td>
                                </tr>
                            <?php } ?>
                        <style>
