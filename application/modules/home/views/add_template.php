        ...
        <section class="panel col-md-12">
            <header class="panel-heading no-print">
                ...
                if (!empty($template->id))
                    echo 'Modifier '. lang('template');
                else
                    echo 'Ajouter '. lang('template');
                ?>
            </header>
            <div class="no-print row">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="home/addTemplate" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 lab pad_bot row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <?php if (!empty($template->type)) {  ?>
												<option value="<?php echo $template->type; ?>"> Labo</option>
											<?php } ?>
                                        <option value=""></option>
                            ...
                            <input type="hidden" name="id" value='<?php
                                                                    ...
                                                                    ?>'>
                            <div class="col-md-12">
                                <a href="home/template" class="btn btn-info btn-secondary pull-left">Retour</a>
