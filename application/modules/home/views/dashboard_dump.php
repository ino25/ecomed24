...
======================= -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>common/assets/jquery-file-upload/js/jquery.imagesloader.css">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Receptionist', 'Assistant', 'adminmedecin'))) { ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a><i class="fa fa-list-alt"></i><?php echo lang('service'); ?></a></li>
                                <li><a><i class="fa fa-user"></i><?php echo lang('doctor'); ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Receptionist', 'Assistant', 'Laboratorist', 'Doctor', 'adminmedecin', 'Biologiste'))) { ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Assistant'))) { ?>
                                    <li><a href="finance/payment"><i class="fas fa-file-medical-alt"></i> <?php echo lang('liste_actes_menu2'); ?></a></li>

                                <?php } ?>
                                <?php if ($this->ion_auth->in_group(array('Doctor', 'Laboratorist', 'adminmedecin', 'Biologiste', 'Receptionist'))) { ?>
                    ...
                    <?php
                    if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Biologiste'))) {
                    ?>
                         <li>
                                <a href="lab/allActiveLabTest">
                                    <i class="fa fa-flask"></i>
                                    <span><?php echo lang('lab_test_list'); ?></span>
                                </a>
                            </li>
                    ...
                    ?>
                         <li >
                                <a href="lab/allLabTestByOrganisation">
                                    <i class="fa fa-flask"></i>
                                    <span style="font-size:12px !important;"><?php echo lang('imported_lab_test'); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="lab/requestLabTestList">
                                    <i class="fa fa-flask"></i>
                                    <span style="font-size:12px !important;"><?php echo lang('requested').' '.lang('lab_test'); ?></span>
                                </a>
                            </li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'adminmedecin'))) { ?>
                        ...
                        <li><a><i class="fa fa-shield-alt"></i><?php echo "Tiers-Payants" ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('Receptionist', 'admin', 'adminmedecin', 'Assistant'))) { ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a><i class="fa fa-money-check"></i><?php echo lang('service_zuulu'); ?></a></li>
                                <li><a><i class="fa fa-money-check"></i><?php echo lang('expense_menu'); ?></a></li>
                                <li><a><i class="fa fa-plus-circle"></i><?php echo lang('add_expense_menu'); ?></a></li>
                                <li><a><i class="fa fa-edit"></i><?php echo lang('expense_categories'); ?> </a></li>
