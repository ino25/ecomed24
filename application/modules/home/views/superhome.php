        ...
        <section class="panel">
            <header class="panel-heading" style="margin-top:41px;">
                <div class="col-md-4 no-print pull-right">
                    <a href="home/superAddOrganisation">
                        <div class="btn-group pull-right">
                            <button id="" class="btn green btn-xs">
                                <i class="fa fa-plus-circle"></i> Ajouter une organisation
                            </button>
                        </div>
                    </a>
                </div>
                <h2>Liste des <?php echo lang('organisations'); ?></h2>
            </header>
                    ...
                    <table class="table table-hover progress-table" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left !important;width:5% !important;"></th>
                                ...
                                <th style="text-align:left !important;width:10% !important;">Responsable Legal</th>
                                <!--<th style="text-align:left !important;">Tel. Responsable</th>-->
                                <th style="text-align:left !important;">Statut</th>
                                <th class="no-print" style="width:400px;text-align:left !important;width:15% !important;">Actions</th>
                                <th class="no-print" style="text-align:left !important;width:10% !important;">Sous-traitance</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
