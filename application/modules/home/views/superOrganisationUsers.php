		...
		<section class="panel">
                            <header class="panel-heading" style="margin-top:41px;">
								<div class="col-md-4 no-print pull-right"> 
									<a href="home/superAddOrganisationUser?idOrganisation=<?php echo $organisation->id; ?>">
                                ...
                                <h2>Liste des Administrateurs (<?php echo $organisation->nom; ?>)</h2>
                            </header>
								...
								<div class="adv-table editable-table "> 
									<div class="space15"></div>		
                                        <table class="table table-hover progress-table" id="editable-sample">
                                            <thead>
												<tr>
													<th style="text-align:left !important;">Identité</th>
													<th style="text-align:left !important;">Groupe</th>
													<th style="text-align:left !important;">Téléphone</th>
													<!--<th style="text-align:left !important;">PIN</th>-->
													<th style="text-align:left !important;">Email</th>
													<th style="text-align:left !important;">Dernière connexion</th>
													<!--<th style="text-align:left !important;">Création</th>-->
...
$(document).ready(function() {
	...
	var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "home/getOrganisationAdminUsers",
                type: 'POST',
				data : {id: <?php echo $organisation->id; ?>},
            },
            scroller: {
