            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" action="home/addOrganisationAdmin" class="clearfix" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select class="form-control" name="groupe" id="inputGroupe" required>
										...
										<option value="1" <?php
											...
											<option value="14" <?php
																if (!empty($setval) && set_value('groupe') == "14") {
																	echo 'selected';
																}
																if (!empty($user->groupe) && $user->groupe == "14") {
																	echo 'selected';
																}
																?>>Administrateur Labo</option>
									</select>
								</div>
								<div class="form-group">
                            ...
                            <input type="hidden" name="idOrganisation" value='<?php
                            ...
                            <div class="form-group col-md-12">
								<a id="" class="btn btn-info btn-secondary pull-left" href="home/superOrganisationUsers?id=<?php echo !empty($organisation->id) ? $organisation->id : ""; ?>">
									Retour
								</a>
