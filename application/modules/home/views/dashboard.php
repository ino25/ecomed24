...
======================= -->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfobject/2.2.8/pdfobject.min.js" type="text/javascript"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfobject/2.2.8/pdfobject.js" type="text/javascript"></script>
    <!-- Google Fonts -->
                  ...
                  <div class="col-xs-4 text-center">
                    <a href="#">Link 3</a>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-left">
                                        <a href="profile" class="btn btn-default btn-flat">Mes infos</a>
                                    </div>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse" <?php if (isset($afficheMenu) && !$afficheMenu) { ?> style="height: 1266px; margin-left: -210px;" <?php } ?>>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Receptionist', 'Assistant', 'adminmedecin'))) { ?>
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;">
                                ...
                                <span><?php echo lang('dossier_patient_menu'); ?></span>
                            </a>
                            <ul class="sub">
                    ...
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group(array('superlabo'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-sitemap"></i>
                                <span><?php echo lang('med_test_lab'); ?></span>
                            </a>
                            <ul class="sub">
                                <li><a href="home/superprestations"><i class="fa fa-medkit"></i><?php echo lang('testList'); ?></a></li>
                                <!--<li><a  href="email/sendView"><i class="fa fa-location-arrow"></i><?php //echo lang('new'); 
                                                                                                        ?></a></li>
                                    <li><a  href="email/sent"><i class="fa fa-list-alt"></i><?php //echo lang('sent'); 
                                                                                            ?></a></li>
                                   
                                    <li><a  href="email/settings"><i class="fa fa-cogs"></i><?php //echo lang('settings'); 
                                                                                            ?></a></li>-->
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Receptionist', 'Assistant', 'Laboratorist', 'Doctor', 'adminmedecin', 'Biologiste'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                ...
                                <span><?php echo lang('sanitaire'); ?></span>
                            </a>
                            <ul class="sub">
                            <li>
                            <a href="sanitaire">
                        ...
                        <li>
                            <a href="sanitaire/sarsCOV2">
                                <i class="fas fa-prescription"></i>
                                <span> SARS-Cov-2 </span>
                            </a>
                        </li>
                        <li>
                            <a href="sanitaire/rapportActivite">
                                <i class="fas fa-prescription"></i>
                                <span> Rapport activité </span>
                            </a>
                        </li>
                            </ul>
                        </li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('Receptionist', 'admin', 'adminmedecin', 'Accountant', 'Assistant'))) { ?>
                        <li class="sub-menu"><a href="#"><i class="fa fa-list"></i><?php echo lang('gest_partenaire_menu_facturartion'); ?></a>
                            <ul class="sub">
                                ...
                                <li><a href="partenaire/facturesRapport"><i class="fa fa-book"></i><?php echo lang('rapport_presta'); ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('Receptionist', 'admin', 'adminmedecin', 'Assistant'))) { ?>
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="finance/serviceCategory"><i class="fa fa-edit"></i><?php echo lang('cat_service'); ?> </a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <!-- <ul class="sub">
                                <li><a><i class="fa fa-plus-circle"></i><span style="font-size:97%;"><?php echo lang('depot_menu'); ?></span></a></li> -->
                            <!-- <li><a  href="depot/ajouttransfert"><i class="fa fa-plus-circle"></i><?php echo lang('add_transfert'); ?></a></li> -->
                            <!-- <li><a><i class="fa fa-edit"></i><?php echo lang('liste_depot_transfert_menu'); ?> </a></li>
                    ...
                    <!-- <li><a href="finance/paymentCategory"><i class="fa fa-medkit"></i><?php echo lang('payment_procedures_menu'); ?></a></li> -->
                    <!-- <li><a><i class="fa fa-shield-alt"></i><?php echo "Gestion Tiers-Payants" ?></a></li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-money-check"></i>
                                <span><?php echo lang('services'); ?></span>
                    ...
                    <?php if ($this->ion_auth->in_group(array('Doctor','adminmedecin'))) { ?>
                            ...
                            <li>
                                <a href="prescription/transferedPrescription" >
                                    <i class="fas fa-prescription"></i>
                                    <span><?php echo lang('transfer'); ?> <?php echo lang('prescription'); ?> </span>
                                </a>
                            </li>
                        <?php } ?> 
...
<?php if ($this->ion_auth->in_group(array('Doctor','adminmedecin'))) { ?>
                            <li>
                                <a href="prescription/genererDocument" >
                                    <i class="fas fa-prescription"></i>
...
*
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <!--                        <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a  href="medicine/medicineList"><i class="fa fa-medkit"></i><?php echo lang('medicine_list'); ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group('Pharmacist')) { ?>
                        ...
                        <li>
                            <a href="medicine">
                                <i class="fa fa-medkit"></i>
                                <span> <?php echo lang('imported_medicine'); ?> </span>
                            </a>
                        </li>
                        <li>
                            <a href="medicine/requestMedicine">
                                <i class="fa fa-medkit"></i>
                                <span> <?php echo lang('request_medicine'); ?> </span>
                            </a>
                        </li>
                        <li>
                            <a href="prescription/transferedPrescription">
