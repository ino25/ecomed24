...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        $patient = $this->patient_model->getPatientById($visite->patient_id, $this->id_organisation);
        $user = $this->patient_model->getUserById($visite->user, $this->id_organisation);
        ?>
        ...
        <div class="col-md-8 panel bg_container margin_top" id="prescription">
            <div class="bg_prescription">
                ...
                <div class="panel-body">
                    <div class="">
                        <h5 class="col-md-4 prescription"><?php echo lang('date'); ?> : <?php echo date('d-m-Y H:i', $visite->date); ?></h5>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="panel-body">
                            <div style="padding-left: 10px; ">
                                <strong style="border-bottom: 1px solid #000;">Médicament</strong>
                            </div>
                            <div class="panel-body">
            ...
            <div class="panel-body prescription_footer">
                <div class="col-md-4 pull-left">
                    <hr> <?php echo lang('signature'); ?></div>
                <div class="col-md-8 pull-right text-right">
                    <h3 class='hospital'><?php echo $this->nom_organisation; ?></h3>
                </div>
            </div>
