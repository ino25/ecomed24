    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2><?php echo lang('liste_visite_general'); ?></h2>
            </header>
                        ...
                        <tbody>
                            ...
                            if (isset($visites)) {
                                foreach ($visites as $visite) {
                                    $options2 = '<a class="btn btn-info btn-xs invoicebutton" title="' . lang('invoice') . '" style="color: #fff;" href="visite/visiteInvoice?id=' . $visite->idv . '"><i class="fa fa-file-invoice"></i> </a>';
                            ?>
                                    <tr class="">
