...
<section id="main-content">
    <form role="form" action="visite/addNew" id="visiteaddNew" method="post" enctype="multipart/form-data">
        <section class="wrapper site-min-height">
            <!-- page start-->
            <section class="panel">
                <header class="panel-heading" style="margin:0px">
                    <h2><?php
                        if (!empty($visite->id))
                            echo lang('consultation_general');
                        else
                            echo lang('consultation_general');
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="" id="visitegenerale">
                                                <div class="col-md-12 lab pad_bot">
                                                    ...
                                                    <div class="col-md-6 lab pad_bot">
                                                        <label for="exampleInputEmail1"><?php  echo lang('BU'); ?></label>
                                                        <input type="text" class="form-control" id="urine" name="bu" value='' placeholder="">
                                                    </div>
                                                    <div class="col-md-6 lab pad_bot">
                                                        <label for="exampleInputEmail1"><?php echo lang('dextro'); ?></label>
                                                        <input type="text" class="form-control" id="dextro" name="dextro" value='' placeholder="">
                                                    </div>
                                                    <div class="col-md-6 lab pad_bot">
                                                        <label for="exampleInputEmail1"><?php echo lang('taille'); ?></label>
                                                        <input type="number" class="form-control" id="taille" name="taille" value='' placeholder="" onkeyup="DonneeInsert(event)">
                                                        <code id="tailleDonne" class="flash_message" style="display:none">La taille doit être comprise entre 45 et 290 cm </code>
                                                    </div>
                                                    <div class="col-md-6 lab pad_bot">
                                                        <label for="exampleInputEmail1"><?php echo lang('poids'); ?></label>
                                                        <input type="number" class="form-control" id="poids" name="poids" value='' placeholder="" onkeyup="DonneeInsert(event)">
                                                        <code id="poidsDonne" class="flash_message" style="display:none">Le poids doit être compris entre 1 et 250 kg</code>
                                                    </div>
                                                        ...
                                                        <table style="width:100%">
                                                            <tr>
                                                                ...
                                                                <th style="width: 27%;"><label for="exampleInputEmail1"><?php echo lang('systolique'); ?></label>
                                                                    ...
                                                                    <code id="systoleDonne" class="flash_message" style="display:none">La valeur doit être un entier positif</code>
                                                                </th>
                                                                <th style="width: 1%;"> </th>
                                                                <th style="width: 2%;"> </th>
                                                                <th style="width: 27%;"><label for="exampleInputEmail1"><?php echo lang('diastolique'); ?></label>
                                                                    ...
                                                                    <code id="diastoleDonne" class="flash_message" style="display:none">La valeur doit être un entier positif</code>
                                                                </th>
                                                                <th style="width: 2%;"></th>
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="ckeditor form-control" id="editor" name="description" value="" rows="20"><?php
                                                                                                                                                    if (!empty($setval)) {
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label><?php echo lang('dateRV'); ?></label>
                                                        <input id="date_validAssurance" class="form-control form-control-inline input-medium before_now" type="text" name="rendezVous" value="" placeholder="" autocomplete="off">
                                                    </div>
                                                    <!-- <div class="col-md-12 lab pad_bot">
                                                    ...
                                                    <div class="col-md-12 lab">
                                                        <a href="visite/listeConsultation" class="btn btn-info btn-secondary pull-left">Retour</a>
                ...
                <div class="panel-body" id="pageconfirmation" style="display: none;">
                            ...
                            <div>
                                <div class="col-md-12">
                                    <table>
                                        ...
                                        <tr>
                                            <th style="width: 25%;"><label class="grandeligne">Bilan Urinaire</label></th>
                                            <th style="width: 10%;"></th>
                                            <th style="width: 65%;"><label class="petiteligne" id="urineConfirmation"></label></th>

                                        </tr>
                                        <tr>
                                            <th style="width: 25%;"><label class="grandeligne"><?php echo lang('dextro') ?></label></th>
                                            <th style="width: 10%;"></th>
                                            <th style="width: 65%;"><label class="petiteligne" id="dextroConfirmation"></label></th>

                                        </tr>
                                        <tr>
                                            <th style="width: 25%;"><label class="grandeligne"><?php echo lang('dateRV') ?></label></th>
                                            <th style="width: 10%;"></th>
                                            <th style="width: 65%;"><label class="petiteligne" id="rvConfirmation"></label></th>
                                        </tr>
                                       <!-- 
                                        <tr>
                    ...
                    <div class="col-md-10 lab">
                        ...
                        <form role="form" novalidate action="visite/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                            ...
                            <input hidden type="text" id="buhidden" name="buhidden" value="">
                            <input hidden type="text" id="dextrohidden" name="dextrohidden" value="">
                            <input hidden type="text" id="rvhidden" name="rvhidden" value="">
                            ...
                            <input hidden type="text" name="type" value="consultation">
...
<script>
    $(document).ready(function() {
        ...
        document.getElementById('redirectaddNew').value = 'visite/ajoutConsultation';
...
<script>
    ...
    function tensionArterielles(event) {
        ...
        var diastoleDonne = document.getElementById("diastoleDonne");
        var systoleDonne = document.getElementById("systoleDonne");
        ...
        if( diastolique < 0){
            diastoleDonne.style.display = "block";
            bt.disabled = true;
        }else if(systolique < 0){
            systoleDonne.style.display = "block";
            bt.disabled = true;
        }
        else{
            diastoleDonne.style.display = "none";
            systoleDonne.style.display = "none";
            bt.disabled = false;
        }
        $('#tension').html(``);
    ...
    $("#continuer").click(function(e) {
        ...
        var Bu = $('#urine').val();
        var Dextro = $('#dextro').val();
        var dateRV = $('#date_validAssurance').val();
        var taille = $('#taille').val();
        var poids = $('#poids').val();
        var systolique = $('#systolique').val();
        var diastolique = $('#diastolique').val();
        ...
        //alert('T.Systolique: ' + systolique + ' (mmHg) | ' + 'T.Diastolique: ' + diastolique + ' (mmHg)');
        document.querySelector('#dateConfirmation').innerHTML = date;
        document.querySelector('#patientConfirmation').innerHTML = patient;
        document.querySelector('#pignetConfirmation').innerHTML = 'Taille:' + taille + ' cm | ' + 'Poids: ' + poids + ' kg ';
        ...
        document.querySelector('#urineConfirmation').innerHTML = Bu;
        document.querySelector('#dextroConfirmation').innerHTML = Dextro;
        document.querySelector('#rvConfirmation').innerHTML = dateRV;
        ...
        document.getElementById('buhidden').value = Bu;
        document.getElementById('dextrohidden').value = Dextro;
        document.getElementById('rvhidden').value = dateRV;
    ...
    function DonneeInsert(){
        var poids = $("#poids").val();
        var poidsDonne = document.getElementById("poidsDonne");
        var taille = $("#taille").val();
        var tailleDonne = document.getElementById("tailleDonne");
        var bt = document.getElementById('continuer');
        poids = parseInt(poids);
        poidsDonne.style.display = "none";
        tailleDonne.style.display = "none";
        if(poids < 1 || poids > 250){
            poidsDonne.style.display = "block";
            bt.disabled = true;
        }else if(taille < 45 || taille > 290){
            tailleDonne.style.display = "block";
            bt.disabled = true;
        }
        else{
            poidsDonne.style.display = "none";
