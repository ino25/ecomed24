...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <form role="form" id="editLabForm" class="clearfix" action="finance/editStatutPaiementByJasonAccept" method="post" enctype="multipart/form-data">
            ...
            <section class="panel col-md-12 no-print">
                <header class="panel-heading no-print">
                    ...
                    echo lang('traitance') . ': ' . lang('valid_lab_report');
                    ?>
                </header>
                <div class="no-print">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4" style="margin-top: 35px;">
                                    <div class="text-center">
                                        ...
                                        <?php if ($mode != 'on') { ?>
                                            <span id="rejet" class="btn btn-info btn-danger " onclick="rejetbutton('<?php echo $payment; ?>')"><?php echo lang('close-rejet'); ?></span>
                                            <button id="valid" type="submit" name="submit" id="submit" <?php if ($typ == 'deb' || $typ == 'fin') {
                                                                                                            echo 'disabled';
                                                                                                        } ?> <?php if ($typ == 'deb' || $typ == 'fin') {
                                                                                                                        echo 'disabled';
                                                                                                                    } ?> class="btn btn-info pull-right"><?php echo lang('accept'); ?></button>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                ...
                if (details) {
                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                     ...
                     <input type='hidden' id='' name='nomParam[]' value=\"" + prestas[1] + "\" /><input type='hidden' id='' name='values[]' value=\"" + idPaymentConcatRelevantCategoryPart + "\" /><input type='hidden' id='' name='idPrestation[]' value=\"" + idPrestation + "\" /><input type='hidden' id='' name='codes[]' value=\"" + idPayment + "\" /></td>";
                            addedHtml += "<td style='width:20%'><input class='form-control shadow' size='15' max-length='15' type='hidden' readonly id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" /><strong>" + prestas[1] + "</strong></td>";
                            addedHtml += "<td style='width:25%'><input class='form-control shadow' size='5' readonly max-length='5' type='hidden' id='' name='' value=\"" + prestas[2] + "\" /><strong>" + prestas[2] + "</strong></td>";
                            addedHtml += "<td style='width:25%'><input class='form-control shadow' size='5' readonly  max-length='5' type='hidden'  id='' name='' value=\"" + prestas[3] + "\" placeholder='' /><strong>" + prestas[3] + "</Strong></td>";
                            addedHtml += "</tr>";
...
<script>
    ...
    function rejetbutton(payment) {
        ...
        html += ' <span id="rejetbuttonJson*" onclick="rejetbuttonJson(' + payment + ')"   class="btn btn-info row pull-right"> <?php echo lang('submit'); ?></span>';
        html += '  </div>';
        html += ' </form>';
        html += ' </div>';
