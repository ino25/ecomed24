            ...
            <header class="panel-heading">
                ...
                <?php if (!$this->ion_auth->in_group('Laboratorist')) { ?>
                    <div class="col-md-4 no-print pull-right"> 
                        <a  href="lab/addLabTestMasterView">
                 ...
                 <div class="col-md-4 btn-group pull-right" style="margin-right:-220px;">
                            <button id="" class="btn green btn-xs downloadbutton">
                                <i class="fa fa-plus-circle"></i>&nbsp;<?php echo lang('import'); ?> <?php echo lang('lab_test'); ?>
                            </button>
                        </div>
                <?php } ?>
            </header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo lang('import'); ?> <?php echo lang('lab_test'); ?> (xls, xlsx) </h4>
            </div>
			
            <div class="modal-body">
			<div class="btn-group" style="margin-right:5px;">
                            <a id="" class="btn green btn-xs btn-secondary" href="files/downloads/master_lab_test.xlsx">
                ...
                <form role="form" id="departmentEditForm" class="clearfix" action="home/importMasterLabTest" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-feedback">
                                    ...
                                    <input type="hidden" name="tablename"value="master_lab">
                                </div>
