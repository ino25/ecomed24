...
<section id="main-content">
    <section class="wrapper site-min-height">
                ...
                <main>
                    ...
                    <?php if (!empty($payments->purpose)) { ?>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="" id="exampleInputEmail1" value='<?php echo $patient->passport; ?>' placeholder="" readonly="">
                        </div>
        ...
        <div class="col-md-8">
            ...
            <?php
            if ($payments->status === "valid" || $payments->status === "accept") {
            ...
            ?>
                    ...
                    <?php if (!empty($email_light)) { ?>
                        <button id="transferlight" data-id="<?php echo $payments->id ?>" class="btn btn-info green btn-sm">
                            <i class="fa fa-paper-plane"></i> <?php if (!empty($email_light)) {
                                                                    echo 'Envoyer à la structure ' . $id_light_info->nom;
                                                                } else {
                                                                    echo lang('transfert');
                                                                }  ?>
                        </button>
                    <?php } else { ?>
                        ...
                        <!-- <a href="finance/getActeJson?id=<?php echo $payments->id ?>" id="JsonPayment" class="btn btn-info green btn-sm">
                            <i class="fa fa-eye"></i> Infos JSON
                        </a>  -->
                    <?php } ?>
            ...
            <div class="modal-body">
                <form role="form" id="transferLabReport" action="finance/transferLaboLight" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12 email_div">
                        ...
                        <input type="hidden" name="id_payment" value="<?php echo $payments->id; ?>">
                        <input type="hidden" name="prestation" value="<?php echo $prestation; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="transferLabReport" action="finance/transferLabo" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                    <label class="radio-inline"><input type="radio" class="medium" name="medium" value='destinataire' checked onchange="handleChange(this);">Impression</label>
                        <label class="radio-inline"><input type="radio" class="medium" name="medium" value='email' onchange="handleChange(this);"><?php echo lang('email'); ?></label>
                        <label class="radio-inline"><input type="radio" class="medium" name="medium" value='whatsapp' disabled><?php echo lang('whatsapp'); ?> (Bientôt Disponible)</label>
                    </div>
                    <div id="wathsapForm" class="form-group col-md-12 whatsapp" style="display:none">
                        <label for="exampleInputEmail1"> <?php echo lang('whatsapp_number'); ?><span></span></label>
                        <input type="number" class="form-control" name="whatsapp" id="what_num" value="<?php echo $patient->phone; ?>" placeholder="">
                    </div>
                    <div id="emailForm" class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1"> <?php echo lang('email'); ?></label>
                        <input type="email" class="form-control" name="email" id="email_id_lab" value="<?php if (!empty($email_light)) {
                                                                                                        echo $email_light;
                                                                                                    } else {
                                                                                                        echo $patient->email;
                                                                                                    }
                    ...
                    <div id="destinataireForm" class="form-group col-md-12">
                        <label for="exampleInputEmail1">Destinataire</label>
                        <input type="text" class="form-control" name="destinataire" id="destinataire_id_lab" value="<?php if (!empty($email_light)) {
                                                                                                                    echo $email_light;
                                                                                                                } else {
...
<script>
    function handleChange(src) {
        if (src.value === "email") {
            document.getElementById('destinataireForm').style.display = 'none';
            document.getElementById('emailForm').style.display = 'block';
            $('#email_id_lab').prop('required', true);
            $('#destinataire_id_lab').prop('required', false);
        } else if (src.value === "destinataire") {
            document.getElementById('destinataireForm').style.display = 'block';
            document.getElementById('emailForm').style.display = 'none';
            $('#email_id_lab').prop('required', false);
            $('#destinataire_id_lab').prop('required', true);
        } 
    }
