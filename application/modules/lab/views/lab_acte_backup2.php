            ...
            <div class="panel panel-primary" id="invoice">
                ...
                <main>
                    ...
                    <form role="form" id="editLabForm" class="clearfix" action="lab/addLabNewPayment" method="post" enctype="multipart/form-data">
                        ...
                        <!-- <div class="wrapper"> -->
                        <!-- <input type="checkbox" id="selectAll" value="selectAll"> Tout<br /><br /> -->
                        <!-- <div class="header">
                                <h3>Items</h3>
                            </div> -->
                        <!-- <div id="itemForm">
                                ...
                                <div class="item">
                                    1
                                    <label class="container_checkbox">
                                        <input id="yellow" type="checkbox" value="selectAll">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                ...
                                <div id="itemForm">
                                    <div class="item">
                                        <thead style="margin-top:5px;">
                                            <tr>
                                                <th style="text-transform:none !important;" scope="col">

                                                    <label class="container_checkbox">
                                                        <input type="checkbox" id="selectAll" value="selectAll">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <strong style="margin-left:55%;padding-top:-15px"> Tout</strong>
                                                </th>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                if (details) {
                    addedHtml += "<tr>";
                    addedHtml += "<td style='width:10%'><label class='container_checkbox'><input type='checkbox' id='' name='idParam[]' value=\"" + idPrestation + " \"> <span class='checkmark'></span></label></td>";
                    addedHtml += "<td></td>";
                    addedHtml += "<td style='font-weight:1500;'>";
                    addedHtml += "<div><h4>" + prestation + " " + "</h4>" + "<input type='hidden' id='prestations' name='prestations' value=\"" + idPrestation + "\" /> </div>";
                    addedHtml += "</td>";
                    addedHtml += "</tr>";
                        ...
                        if (tabDetails[ii]) {
                            ...
                            if (prestas[7] === 'setofcode') {
                                if (prestas[8]) {
                                    addedHtml += "<tr>";
                                    addedHtml += "<td></td>";
                                    addedHtml += "<td style='font-weight:500px;'><strong>" + prestas[1] + "</strong><input class='form-control shadow' size='35' readonly type='hidden' id='' name='' value=\"" + prestas[1] + " \" /><input type='hidden' id='' name='idParam[]' value=\"" + prestas[0] + "\" />\n\
