        ...
        <div class="container-fluid invoice-container col-md-12">
            ...
            <div class="panel panel-primary" id="invoice">
                ...
                <main>
                    ...
                    <form role="form" id="editLabForm" class="clearfix" action="finance/editStatutPaiementByJasonEdit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="doctor" id="exampleInputEmail1" value='<?php if (!empty($payments->doctor_name)) {
                                                                                                                    ...
                                                                                                                    } else echo 'Non renseigné '  ?>' placeholder="">
                            <input type="hidden" name="doctor" value="<?php echo $payments->doctor_name ?>">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputEmail1">Date prescription</label>
                            <input type="text" class="form-control" name="dateprescription" id="exampleInputEmail1" value='<?php echo $payments->date_string; ?>' placeholder="">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group" id="id_0">
                                <input type="text" value="<?php
                                                            ...
                                                            ?>" class="form-control <?php if (empty($payments->date_prelevement)) { ?> datetimepicker_ip <?php } ?>" name="date_prevelement" required=""  autocomplete="off">
                    ...
                    text-align: center;">R&Eacute;SULTATS DES ANALYSES</div>
                        ...
                        <div class="col-md-12 lab pad_bot" id="report_group">
                            ...
                            <div class="col-md-12" style="padding-top:35px;">
                                ...
                                <?php if ($mode != 'on') { ?>
                                    <span style="display:none"  id="rejet" class="btn btn-info btn-danger " <?php if ($typ == 'deb' || $typ == 'fin') {
                                                                                            echo 'disabled';
                        ...
                        <input type="hidden" name="id_doctor" value='<?php echo $this->ion_auth->user()->row()->id; ?>'>
            ...
            <div class="col-md-12 signatture_class pull-right">
                ...
                ?>
                        <button style="display:none"  class=" no-print pull-right btn btn-sm btn-primary" style="display:none" id="signature"><?php echo lang('signature'); ?></button>
                    <?php } else { ?>
                        ------------------------------------<br>
