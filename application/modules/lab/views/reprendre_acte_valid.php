                ...
                if (details) {
                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                     ...
                     <input type='hidden' id='' name='nomParam[]' value=\"" + prestas[1] + "\" /><input type='hidden' id='' name='values[]' value=\"" + idPaymentConcatRelevantCategoryPart + "\" /><input type='hidden' id='' name='idPrestation[]' value=\"" + idPrestation + "\" /><input type='hidden' id='' name='codes[]' value=\"" + idPayment + "\" /></td>";
                            ...
                            addedHtml += "<td style='width:25%;padding-top:15px'><input class='form-control shadow' size='5' readonly max-length='5' type='hidden' id='' name='' value=\"" + prestas[2] + "\" /><strong>" + prestas[2] + "</strong></td>";
                            addedHtml += "<td style='width:25%;padding-top:15px'><input class='form-control shadow' size='5' readonly  max-length='5' type='hidden'  id='' name='' value=\"" + prestas[3] + "\" placeholder='' /><strong>" + prestas[3] + "</strong></td>";
                            addedHtml += "</tr>";
