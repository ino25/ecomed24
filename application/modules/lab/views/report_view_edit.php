    ...
    <section class="wrapper site-min-height">
        <div class="container-fluid invoice-container col-md-10">
            ...
            <div class="panel panel-primary" id="invoice">
                ...
                <br>
                <main>
                <form role="form" action="finance/editStatutPaiementValidEdit" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <?php if (strtolower($lab_details->name) == 'pcr') { ?>
                        <div class="form-group col-md-4">
                            ...
                            <input type="hidden" class="form-control" id="passport" value='<?php echo $patient_details->passport; ?>' placeholder="">
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            ?>
                            <input type="text" class="form-control" name="purpose" id="exampleInputEmail1" value='<?php echo $purpo; ?>' placeholder="">
                            <input type="hidden" class="form-control" name="id_purpose" id="purpose" value='<?php echo $id_purpo; ?>' placeholder="">
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" class="form-control" name="id_type_of" id="type_of" value='<?php echo $this->db->get_where('sampling', array('id' => $report_details->sampling))->row()->id; ?>' placeholder="">
                    </div>
                    <style>
                        .rowStyle {
                    ...
                    <div class="col-md-12 signatture_class pull-right">
                        ...
                        ?>
                                <button style="display:none" class=" no-print pull-right btn btn-sm btn-primary" id="signature"><?php echo lang('signature'); ?></button>
                            <?php } else { ?>
                                ------------------------------------<br>
        ...
        <div class="col-md-10">
            <div class="row">
                <div class="col-md-4" style="padding-top: 15px;">
                    ...
                    <button style="display: none;" class=" btn btn-sm btn-danger" id="reprendre"><?php echo lang('close-rejet'); ?></button>
                </div>
                <div class="col-md-4">
                </div>
                <div class="col-md-4">
                        ...
                        <button id="validerActe" type="submit" name="submit" id="submit" class="btn btn-info pull-right" style="padding-top: -15px;"><?php echo lang('valid'); ?></button>
                    </form>
                </div>
            </div>
