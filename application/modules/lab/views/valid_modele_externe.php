                    ...
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            ...
                            <div class="col-md-12 lab pad_bot" id="report_group">
                                ...
                                <div class="col-md-11"> 
                                    <textarea class="ckeditor form-control" name="resultats[]" value="" rows="10" readonly><?php echo $lab->resultats ?>
                                    </textarea>
                                </div>
                                <p>&nbsp;</p>
                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                     ...
                     <input type='hidden' id='' name='nomParam[]' value=\"" + prestas[1] + "\" /><input type='hidden' id='' name='values[]' value=\"" + idPaymentConcatRelevantCategoryPart + "\" /><input type='hidden' id='' name='idPrestation[]' value=\"" + idPrestation + "\" /><input type='hidden' id='' name='codes[]' value=\"" + idPayment + "\" /></div>";
                           // addedHtml += "<td style='width:25%><input class='form-control shadow' size='15' max-length='15' type='hidden' readonly id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" /><strong>" + prestas[4] + "</strong></td>";
                            ...
                            addedHtml += "<div><input class='form-control shadow' size='5' readonly  max-length='5' type='hidden'  id='' name='' value=\"" + prestas[3] + "\" placeholder='' /></div>";
