                    ...
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                                    ...
                                    <div class="col-md-6 pull-left">
                                        <div class='row'>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="hidden" value="<?php echo $patient->patient_id; ?>" name="patientIDReport">
                                                <input type="hidden" value="<?php echo $patient->name . ' ' . $patient->last_name; ?>" name="patientNameReport">
                                                <input type="hidden" value="<?php echo $patient->birthdate ; ?>" name="patientbirthdate">
                            ...
                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail1"> Date de prélèvement :</label>
                                <input class="form-control form-control-inline input-medium before_now" type="text" id="add_hospitalisation" name="date_prelevement" value="" placeholder="" autocomplete="off" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail1"> Heure</label>
                                <div class="input-group bootstrap-timepicker">
                                    <input type="text" class="form-control timepicker-24" name="heure_prelevement" id="exampleInputEmail1" value='' required="">
                            ...
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1"> Type de prélèvement</label>
                                ...
                                <div class="pos_client clearfix">
                                    <div class="col-md-6 payment pad_bot pull-right">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="c_description" id="exampleInputEmail1" value='' placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        $("#pos_select").select2({
            placeholder: 'Selectionner un type de prélèvement',
            allowClear: true,
            ajax: {
                url: 'finance/getPrelevement',
                type: "post",
                dataType: 'json',
                delay: 250,
                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                        ...
                        if (tabDetails[ii]) {
                            ...
                            if (prestas[1] === 'RESULTAT') {
                                ...
                                addedHtml2 += '<option value="">Non renseigné</option>';
                                addedHtml2 += '<option value="NEGATIF">NEGATIF</option>';
                            ...
                            if (prestas[1] === 'CONCLUSION') {
                                ...
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="">Non renseigné</option>';
                                addedHtml2 += '<option value="Recherche de Coronavirus SARS-COV-2 NEGATIVE">Recherche de Coronavirus SARS-COV-2 NEGATIVE</option>';
                                addedHtml2 += '<option value="Recherche de Coronavirus SARS-COV-2 POSITIVE">Recherche de Coronavirus SARS-COV-2 POSITIVE</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
