                                        ...
                                        <div class="col-md-3 thumbnail">
                                            <div class="col-md-12-">
                                                <div class="col-md-12- right-six-">
                                                    ...
                                                    <div id="renseignementClinique" class="col-md-12 pull-left payment right-six">
                                                        <div class="payment_label">
                                                    ...
                                                    <div id="patientTestCovid" style="display:none">
                                                        <div class="form-group col-md-12">
                                                            <label for="exampleInputEmail1">N° PASSPORT</label>
                                                            <input type="text" class="form-control" name="patientPassport" id="patientPassport" value='' placeholder="N° PASSPORT">
                                                        </div>
                                                        <div class="form-group col-md-12">
