                    ...
                    for (ii = 0; ii < tabDetails.length; ii++) {
                        ...
                        if (tabDetails[ii]) {
                            ...
                            if (prestas[1] === 'Aspect') {
                                ...
                                addedHtml2 += '<option value="Urines claires">Urines claires</option>';
                                addedHtml2 += '<option value="Urines légèrement troubles">Urines légèrement troubles</option>';
                                addedHtml2 += '<option value="Urines troubles">Urines troubles</option>';
                                addedHtml2 += '<option value="Urines limpides">Urines limpides</option>';
                                addedHtml2 += '<option value="Urines hématiques">Urines hématiques</option>';
                                addedHtml2 += '<option value="Urines purulentes">Urines purulentes</option>';
                                addedHtml2 += '<option value="Ecouvillonnage">Ecouvillonnage</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += '</div>';
                                addedHtml2 += "</div>";
                                addedHtml2 += "</br>";
                            ...
                            if (prestas[1] === 'Leucocytes') {
                                addedHtml2 += '<div class="col-md-6 form-inline">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label> <br>';
                                addedHtml2 += "<input type='text' class='form-control form-inline' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required='' style='width:76%'> /Champ";
                                addedHtml2 += "</div>";

                            }
                            if (prestas[1] === 'Cristaux') {
                                ...
                                addedHtml2 += '<option value="Acide urique">Acide urique </option>';
                                addedHtml2 += '<option value="Urates">Urates</option>';
                                addedHtml2 += '<option value="Oxalate de calcium">Oxalate de calcium</option>';
                                addedHtml2 += '<option value="Cystine">Cystine</option>';
                                addedHtml2 += '<option value="Sulfamides">Sulfamides </option>';
                                addedHtml2 += '<option value="Cholesterol">Cholesterol</option>';
                                addedHtml2 += '<option value="Phosphate de calcium">Phosphate de calcium</option>';
                                addedHtml2 += '<option value="Phosphate ammoniaco-magnésien">Phosphate ammoniaco-magnésien</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += "</div>";
                            }
                            if (prestas[1] === 'Hématies') {
                                addedHtml2 += '<div class="col-md-6 form-inline">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label> <br>';
                                addedHtml2 += "<input type='text' class='form-control form-inline' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required='' style='width:76%'> /Champ";
                                addedHtml2 += "</div>";
                            ...
                            if (prestas[1] === 'Filaments mycéliens') {
                                ...
                                addedHtml2 += '<option value="Absence">Absence</option>';
                                addedHtml2 += '<option value="Présence">Présence</option>';
                                addedHtml2 += '</select>';                                addedHtml2 += "</div>";
                            }
                            ...
                            if (prestas[1] === 'Schistosoma haematobium') {
                                addedHtml2 += '<div class="col-md-6 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1"></label>';
                                addedHtml2 += "</div>";
                                addedHtml2 += '<div class="col-md-6 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1" style="font-style: italic;">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Non demandé">Non demandé</option>';
                                addedHtml2 += '<option value="Absence">Absence</option>';
                                ...
                                addedHtml2 += '</select>';                                addedHtml2 += "</div>";
                                addedHtml2 += "</br>";
                                addedHtml2 += "<h4>CULTURE BACTERIENNE</h4>";
                            }
                            if (prestas[1] === 'Dénombrement des Germes Urinaires (DGU)') {
                                addedHtml2 += '<div class="col-md-9">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += '<div class="col-md-9 form-inline">';
                                addedHtml2 += "<input type='text' class='form-control pay_in' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>  " + prestas[2] ;
                                addedHtml2 += "</div>";
                                addedHtml2 += "</div>";
                            }
                            if (prestas[1] === 'Germes retrouvés') {
                                addedHtml2 += '<div class="col-md-8 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<select class='form-control m-bot15' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\" required=''>";
                                addedHtml2 += '<option value="Non renseigné">Non renseigné</option>';
                                addedHtml2 += '<option value="Absence de germes">Absence de germes</option>';
                                addedHtml2 += '<option value="Klebsiella pneumoniae">Klebsiella pneumoniae</option>';
                                addedHtml2 += '<option value="Escherichia coli">Escherichia coli</option>';
                                addedHtml2 += '<option value="Acinetobacter baumanii">Acinetobacter baumanii</option>';
                                addedHtml2 += '<option value="Pseudomonas aeruginosa">Pseudomonas aeruginosa</option>';
                                addedHtml2 += '<option value="Non fermentaire">Non fermentaire</option>';
                                addedHtml2 += '<option value="Staphylococcus aureus">Staphylococcus aureus</option>';
                                addedHtml2 += '</select>';
                                addedHtml2 += "</div>";
                            }
                            if (prestas[1] === 'CONCLUSION') {
                                addedHtml2 += '<div class="col-md-8 lab pad_bot">';
                                addedHtml2 += '<label for="exampleInputEmail1">' + prestas[1] + '</label>';
                                addedHtml2 += "<textarea rows='4' cols='100' id='resultats_" + prestas[0] + "' name='resultats[]' value=\"" + prestas[4] + "\">Absence de signes biologiques d'infection du tractus urinaire, Infection urinaire à Escherichia coli (antibiogramme joint), Polymicrobiens</textarea>";
                                addedHtml2 += "</div>";
                            }
