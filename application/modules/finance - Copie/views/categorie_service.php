                    ...
                    <a href="finance/addServiceCategoryView">
                        <div class="btn-group pull-right">
                            <button id="" class="btn green btn-xs">
                                <i class="fa fa-plus-circle"></i> <?php echo lang('add_cat_service'); ?>
                            </button>
                        </div>
                    </a>
                </div>
                <h2><?php echo lang('cat_service'); ?></h2>
            </header>
                    ...
                    <table class="table table-hover progress-table" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin','adminmedecin','Receptionist','Doctor'))) { ?>
                        ...
                        <?php foreach ($categories as $category) { ?>
                            <tr class="">
                                ...
                                <td class="col-2 border-0 text-right" style="width: 15%;"><span class="money"><?php echo $category->montant; ?></td>
                                <?php if ($this->ion_auth->in_group(array('admin','adminmedecin','Receptionist','Doctor'))) { ?>
                                    <td class="no-print">
