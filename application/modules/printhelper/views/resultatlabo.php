...
<body>
    ...
    $signature = $this->home_model->get_signature($payments->id_organisation);
    ...
    <div class="col-md-12 invoice_head clearfix">
        ...
        <div class="col-md-6 text-left invoice_head_left">
            ...
            <h5>
                ID Rapport: <strong><?php echo $payments->code; ?></strong><br>
                <small>Report ID:
                </small>
            </h5>
            <h5>
                Date de pr&eacute;l&egrave;vement: <strong><?php echo $payments->date_prelevement; ?></strong><br>
                <small>Sample date:</small>
            </h5>
            <h5>
                Prescripteur: <strong><?php echo $payments->doctor_name; ?></strong><br>
                <small>Prescriber:</small>
            </h5>

            <h5>
                Date rendue: <strong><?php echo $payments->date_rendu; ?></strong><br>
                <small>Date returned:</small>
            </h5>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <thead style="margin-top:5px;">
                <tr>
                    ...
                    <td class="text-center" style="text-transform:none !important;width:10%;">Unit&eacute;</td>
