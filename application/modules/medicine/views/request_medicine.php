    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editMedicineForm" class="clearfix" action="medicine/approvedMedicine" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('status'); ?></label>
                        <select class="form-control m-bot15" name="request" value=''>
                            <option value="Approved" <?php
                            if (!empty($medicine->request)) {
                                if ($medicine->request == 'Approved') {
                                    echo 'selected';
                                }
                            }
                            ...
                            if (!empty($medicine->request)) {
                                if ($medicine->request == 'Decline') {
                                    echo 'selected';
                                }
                            }
                            ?> > <?php echo lang('decline'); ?> </option>

                        </select>
                    </div>
                    <input type="text" name="requested_id" value=''>
                    <input type="hidden" name="pharmacist_id" value="<?php echo $pharmacist_id ?>">
                    <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".table").on("click", ".load", function () {
            ...
            // Populate the form fields with the data returned from server
            $('#editMedicineForm').find('[name="requested_id"]').val(iid).end()
        });
    });
</script>
...
<script>
    ...
    $(document).ready(function () {
        var table = $('#editable-sample1').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "medicine/getRequestMedicineList",
                type: 'POST',
            },
            scroller: {
