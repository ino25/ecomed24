...
class Email extends MX_Controller {
    ...
    public function index() {
        ...
        $this->load->view('home/superdashboard'); // just the header file
    ...
    function sent() {
        ...
        $this->load->view('home/superdashboard');
    ...
    function getManualEmailTemplateList() {
        ...
        foreach ($data['cases'] as $case) {
            ...
            if ($this->ion_auth->in_group(array('admin'))) {
                ...
                $options1 = ' <a type="button" class="btn btn-success btn-xs btn_width editbutton1" title="' . lang('edit') . '" data-toggle = "modal" data-id="' . $case->id . '"><i class="fa fa-edit"> </i></a>';
                // $options1 = '<a type='button" class="btn btn-success btn-xs btn_width" title="" . lang('edit') . '"data-toggle = "modal" data-id="' . $case->id . '"><i class="fa fa-edit"></i></a>';
                $options2 = '<a class="btn btn-danger btn-xs btn_width" title="' . lang('delete') . '" href="email/deleteManualEmailTemplate?id=' . $case->id . '&redirect=sms/smsTemplate" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash-o"></i></a>';
            }
            $info[] = array(
                $i,
                $case->name,
