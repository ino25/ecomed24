    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading" style="margin-top:41px;">
                ...
                <h2><?php echo lang('time_schedule'); ?> du Dr <?php  $tr = $this->db->get_where('users', array('id' => $doctorr))->row(); echo $tr->first_name .' '.$tr->last_name; ?></h2>
            </header>
...
<!--                              -->-->
<!--            <a class="btn btn-info btn-xs btn_width delete_button" href="horaire/deleteSchedule?id=--><?php //echo $schedule->id; ?><!--&doctor=--><?php //echo $doctorr; ?><!--&weekday=--><?php //echo $schedule->weekday; ?><!--" onclick="return confirm('Souhaitez-vous supprimer cette hooraire ?');"><i class="fa fa-trash"> </i> --><?php //echo lang('delete'); ?><!--</a>-->
<!--        </td>-->
<!--    </tr>-->
<?php //} ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="horaire/addSchedule" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="redirect" value='horaire/timeSchedule?doctor=<?php echo $doctorr;?>'>
...
<div class="modal fade ajouthoraire" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editTimeSlotForm" action="horaire/addSchedule" method="post" enctype="multipart/form-data">
...
<script>
    ...
    responsive: true,
        ...
        "searchable": true,
        "ajax": {
            url: "horaire/getTimeSchedules?doctor=<?= $doctorr; ?>",
            type: 'POST',
        },
