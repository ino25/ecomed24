 ...
 <!-- Modal -->
  <div class="modal fade" id="my_medicine_modal" role="dialog">
	...
	<form id='medi_form' method='post'>
		  ...
		  <div class="form-group">
			<label for="name_gen"><?php echo lang('Nom_generique'); ?> </label>
                        <input type="text" class="form-control"  name='name_gen' id="name_gen" required="">
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
			<label for="pwd"><?php echo lang('Category'); ?></label>
			<select class='form-control'  name='med_Category'>
                            <option value="1">Gélule</option>
				<option value="2">Comprimé</option>
				<option value="3">Sachet</option>
				<option value="4">Sirop</option>
				<option value="5">Crème</option>
				<option value="6">Onguent</option>
			</select>
		  </div>
		  <div class="form-group">
			<label for="Company"><?php echo lang('Effets_secondaires'); ?> </label>
			<input type="text" class='form-control' name='effets_secondaires'>
		  </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn  btn-secondary" data-dismiss="modal"><?php echo lang('close'); ?><</button>
          <button type="submit" class="btn btn-info pull-right" ><?php echo lang('submit'); ?></button>
		  </form>
        </div>
      </div>
