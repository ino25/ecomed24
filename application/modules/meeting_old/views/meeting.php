                        ...
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-hover progress-table text-center" id="editable-sample5" style="width: 100%;">
                                        <thead>
                                            <tr>
                    ...
                    <div id="requested" class="tab-pane">
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    <div class="space15"></div>
                                    <table class="table table-hover progress-table text-center" id="editable-sample6" style="width: 100%;">
                                        <thead>
                                            <tr>
