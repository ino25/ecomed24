...
$id_partenaire = $this->input->get('idpartenaire');
$id_patient = $this->input->get('idpatient');
$patient_id = $this->patient_model->getPatientById($id_patient,$id_partenaire); ?>
                    ...
                    <div class="clearfix">
                        ...
                        <form role="form" id="editPaymentForm" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
                            <div class="">
                                ...
                                <div class="col-md-12 payment pad_bot liste_partenaire " id="liste_partenaire">
                                    <label for="exampleInputEmail1"> <?php echo lang('partenaire'); ?></label>
                                    <input class="form-control" id="spartenaire" name="partenaire" value='<?php echo $id_partenaire; ?>'>

                                </div>
                                <div class="col-md-12 payment pad_bot liste_partenaire " id="liste_partenaire">
                                    <label for="exampleInputEmail1"> <?php echo lang('partenaire'); ?></label>
                                    <input class="form-control" id="spartenaire" name="patient" value='<?php echo $id_patient; ?>'>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control m-bot15" id="patientchoose" name="patient" value='' required>
                                        <?php if (!empty($prescription->patient)) { ?>
                                            <option value="<?php echo $patient_id->id; ?>" selected="selected"><?php echo $patient_id->name; ?> - (<?php echo lang('id'); ?> : <?php echo $patient_id->last_name; ?>)</option>
                                        <?php } ?>
                                        <?php
                                        if (!empty($setval)) {
                                            $patientdetails = $this->db->get_where('patient', array('id' => set_value('patient')))->row();
                                        ?>
                                            <option value="<?php echo $patient_id->id; ?>" selected="selected"><?php echo $patient_id->name; ?> - (<?php echo lang('id'); ?> : <?php echo $patient_id->id; ?>)</option>
                                        <?php }
                                        ?>
                                    </select>
                                </div>
