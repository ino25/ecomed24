        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-hover progress-table text-center_" id="editable-sample1">
                        <thead>
                            <tr>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('renew'); ?> <?php echo lang('prescription'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editMedicineForm" class="clearfix" action="prescription/renewPrescription" method="post" enctype="multipart/form-data">


                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('renew'); ?> <?php echo lang('date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="renew_date" id="exampleInputEmail1" value='' placeholder="" readonly="">
                    </div>
                    <input type="hidden" name="renew_id" value=''>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('transfer'); ?> <?php echo lang('prescription'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editTransferForm" class="clearfix" action="prescription/transferPrescription" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('pharmacy'); ?></label>
                        <select class="form-control m-bot15 codeip js-example-basic-single" name="pharmacist" value='' required="">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".table").on("click", ".load", function () {
            ...
            $('#myModal3').modal('show');
            $('#editMedicineForm').find('[name="renew_id"]').val(iid).end()
        });
    });
</script>
<script type="text/javascript">
    $(document).ready(function () {
        $(".table").on("click", ".transfer", function () {
            ...
            $('#editTransferForm').trigger("reset");
             $('.codeip').html(" ");
            $.ajax({
                url: 'prescription/getAvailablePharmacyList?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
            }).success(function (response) {
                $('#myModal4').modal('show');
                $('.codeip').html(response.state);
                $('#editTransferForm').find('[name="transfer_id"]').val(iid).end()
            });
