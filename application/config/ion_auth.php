 ...
 */
$config['site_title']                 = "ecomed24.net";       // Site Title, example.com
$config['admin_email']                = "contact@ecomed24.net"; // Admin Email, admin@example.com
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['otp_expiration']     = 900;	// Temps expiration OTP (15min) - en secondes
$config['min_time_before_otp_renewal']     = 43200;	// Temps avant Auth double facteur depuis derniere connexion (12h) - en secondes
 // $config['min_time_before_otp_renewal']     = 4320000000000;	// Temps avant Auth double facteur depuis derniere connexion (12hX100) - en secondes
// $config['min_time_before_otp_renewal']     = 900;	// Temps avant Auth double facteur depuis derniere connexion (12hX100) - en secondes
