...
<div class="login-box logini_box_new">
            <form class="form-signin" method="post" action="auth/appointmentcenterlogin">
                ...
                <div class="login-wrap">
                    <input type="text" class="form-control" name="identity" placeholder="ID PATIENTS klmkmlk" autofocus>
  ...
  <style>
					...
					<!-- <table style="margin-bottom:5px; width: 100%;">
                        ...
                        <!-- <tbody >
                            ...
                            <tr onclick="updateLogin('appointmentcenter@zuulumed.net','12345')">
                                <td>Centre RV</td>
                                <td>appointmentcenter@zuulumed.net</td>
                                <td>12345</td>
                            </tr>
                        </tbody> -->
                    <!-- </table>

					<div class="" style="text-align:center;"><a href="auth/login"><i class="fa icon-lock"></i>&nbsp;Utilisateurs</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="auth/superlogin"><i class="fa fa-lock"></i>&nbsp;Super Admin</a></div>
