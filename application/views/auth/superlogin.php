...
<div class="login-box logini_box_new">
            <form class="form-signin" method="post" action="auth/superlogin">
         ...
         <?php  if($environment == 'dev' ){ ?>
					<table style="margin-bottom:5px; width: 100%;">
                        ...
                        <tbody >
                            ...
                            <tr onclick="updateLogin('superadmin@zuulumed.net','12345')">
                                <td>Super Admin</td>
                                <td>superadmin@zuulumed.net</td>
                                <td>12345</td>
                            </tr>
							<!-- <tr onclick="updateLogin('superadminlabo@zuulumed.net','12345')">
                                <td>Admin Labo</td>
                                <td>superadminlabo@zuulumed.net</td>
                                <td>12345</td>
                            </tr> -->
                        </tbody>
                    </table>

					<div class="" style="text-align:center;"><a href="auth/login"><i class="fa icon-lock"></i>&nbsp;Utilisateurs</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="auth/appointmentcenterlogin"><i class="fa fa-calendar-check"></i>&nbsp;Centre de Rendez-vous</a></div>
         <?php  } ?>			
                </div>
