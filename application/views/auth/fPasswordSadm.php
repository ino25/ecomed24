...
<form class="form-signin" method="post" action="auth/fPasswordSadm" style="max-width: 430px !important;">	
                ...
                <div class="login-wrap">
                   ...
                   <input type="phone" class="form-control" name="phone" id="phone" placeholder="Votre Telephone " autocomplete="off" required="">
                    <p></p>
