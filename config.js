...
const sequelize = new Sequelize(process.env.DB, ((!process.env.NODE_ENV || process.env.NODE_ENV === 'development') ? process.env.USER : process.env.USERNAME), process.env.PASS, {
