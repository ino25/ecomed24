    ...
    $('#pos_select').change(function () {
        ...
        if ($("#spartenaire").val() == null || $("#spartenaire").val() == '') {
            ...
            if (id != 'add_new') {
                ...
                $.ajax({
                    url: 'finance/editMutuelleImagerieFinanceByJason?patient=' + id,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                    // delai: 250
...
$(document).ready(function () {
    ...
    $("#add_service").select2({
        ...
        ajax: {
            ...
            url: 'services/getServicesCoverageByImagerieJson',
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
...
function chargeListePrestation(search = '') {
    ...
    if (!spartenaire) {
        ...
        if (patient && patient != 'add_new') {
            ...
            $.ajax({
                url: 'finance/editImagerieMutuelleFinanceByJason?patient=' + patient + '&id_service_specialite_organisation=' + id_service_specialite_organisation + "&id_assurance=" + assurance_id + "&search=" + search, // CHANGE DONE
                method: 'GET',
                data: '',
				async: false,
                dataType: 'json',
