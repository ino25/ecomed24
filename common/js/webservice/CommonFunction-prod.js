...
var BASE_URL = "https://prod.zuulu.net:5051/zuulu";
...
function loadDons(lang, numPhone, amount, phoneFormat, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + numPhone + '" ttType="R" transferTypeId="370" amount="' + amount + '" FN="GPD" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function validationCredit(lang, numPhone, amount, amountFCFA, phoneFormat, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + numPhone + '" ttType="R" transferTypeId="370" amount="' + amount + '" fromPartnerId="' + formCustmer + '" FN="WP" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function depotOrangeMoney(lang, amount, phoneFormat, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request  FN="WP" fromType="M" transferTypeId="578" mobNo="' + phoneFormat + '" amount="' + amount + '" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function paiementOrangeMoney(lang, amount, phoneFormat, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request  FN="WP" fromType="M" transferTypeId="579" mobNo="' + phoneFormat + '" amount="' + amount + '" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function paiementOrangeMoneyOrganisation(lang, amount, phoneFormat, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request  FN="WP" fromType="M" transferTypeId="580" mobNo="' + phoneFormat + '" amount="' + amount + '" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
  console.log(requestXML);
...
function transfertInterne(lang, amount, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + formCustmer + '" ttType="R" transferTypeId="526" amount="' + amount + '"  FN="GPD" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function validationInterne(lang, amount, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + formCustmer + '" ttType="R" transferTypeId="526" amount="' + amount + '" fromPartnerId="' + formCustmer + '" FN="WP" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function loadDonsWoyofal(lang, numPhone, amount, numeroCompteur, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + numPhone + '" ttType="R" transferTypeId="368" amount="' + amount + '" meterId="' + numeroCompteur + '"  FN="GPD" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function validationWoyofal(lang, numPhone, amount, numeroCompteur, amountFCFA, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request mobNo="' + numPhone + '" ttType="PreE" transferTypeId="368" amount="' + amount + '" meterId="' + numeroCompteur + '" fromPartnerId="' + formCustmer + '" FN="WP" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function fraisSeneau(lang, id, prenom, nom, montant, numeroFacture, delai, custmerReference, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request ttType="PostW" transferTypeId="370" amount="' + montant + '" waterCustmerReference="' + custmerReference + '" FN="GPD" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function paySeneau(lang, custmerReference, montant, numeroFacture, postpaidInvoiceId, amountFCFA, hiddenClient, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request postpaidInvoiceId="' + postpaidInvoiceId + '" ttType="PostE" transferTypeId="334" amount="' + montant + '" invoiceNumber="' + numeroFacture + '" waterCustmerReference="' + custmerReference + '" fromPartnerId="' + formCustmer + '" FN="WP" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function validationZuuluService(lang, formCustmer, pin, to_Custmer, to_pin, amountValidation,idPayment) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request fromCustmer="' + formCustmer + '" toCustmer="' + to_Custmer + '" ttType="" transferTypeId="581" reverse="false" isLocal="true" FN="WP" amount="' + amountValidation + '" PIN="' + pin + '" deviceModel="SM-E7000" devicePlatform="Android" deviceVersion="4.4.2" deviceManufacturer="samsung" packageName="com.zuulu.zuulu" versionNumber="1.0.5" isVirtualDevice="false" geoLatitude="" geoLongitude="" appClientName="Samba Diallo" appType="production" deviceIP="154.124.74.151" ipLocationCode="SN" uniqueDeviceKey="1608979848721" LN="FR"></Request>';
...
function loadDonsZuuluEncaissement(lang, formCustmer, pin, to_Custmer, to_pin, amountValidation) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request fromCustmer="' + formCustmer + '" toCustmer="' + to_Custmer + '" ttType="" transferTypeId="582" reverse="false" isLocal="true" FN="GPD" amount="' + amountValidation + '" PIN="' + pin + '" deviceModel="SM-E7000" devicePlatform="Android" deviceVersion="4.4.2" deviceManufacturer="samsung" packageName="com.zuulu.zuulu" versionNumber="1.0.5" isVirtualDevice="false" geoLatitude="" geoLongitude="" appClientName="Samba Diallo" appType="production" deviceIP="154.124.74.151" ipLocationCode="SN" uniqueDeviceKey="1608979848721" LN="FR"></Request>';
...
function validationZuuluEncaissement(lang, formCustmer, pin, to_Custmer, to_pin, amountValidation,idPayment) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request fromCustmer="' + formCustmer + '" toCustmer="' + to_Custmer + '" ttType="" transferTypeId="582" reverse="false" isLocal="true" FN="WP" amount="' + amountValidation + '" PIN="' + pin + '" deviceModel="SM-E7000" devicePlatform="Android" deviceVersion="4.4.2" deviceManufacturer="samsung" packageName="com.zuulu.zuulu" versionNumber="1.0.5" isVirtualDevice="false" geoLatitude="" geoLongitude="" appClientName="Samba Diallo" appType="production" deviceIP="154.124.74.151" ipLocationCode="SN" uniqueDeviceKey="1608979848721" LN="FR"></Request>';
...
function fraisSenelec(lang, id, prenom, montant, numeroFacture, delai, custmerReference, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request ttType="PostW" transferTypeId="370" amount="' + montant + '" custmerReference="' + custmerReference + '" FN="GPD" fromPartnerId="' + formCustmer + '" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
...
function paySenelec(lang, custmerReference, montant, numeroFacture, postpaidInvoiceId, amountFCFA, formCustmer, pin) {
    ...
    var requestXML = '<?xml version="1.0" encoding="UTF-8" ?><Request postpaidInvoiceId="' + postpaidInvoiceId + '" ttType="PostE" transferTypeId="330" amount="' + montant + '" invoiceNumber="' + numeroFacture + '" custmerReference="' + custmerReference + '" fromPartnerId="' + formCustmer + '" FN="WP" fromCustmer="' + formCustmer + '" PIN="' + pin + '"></Request>';
