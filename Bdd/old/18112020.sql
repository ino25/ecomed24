...
ALTER TABLE `payment_category` ADD `tarif_ipm` INT NULL AFTER `tarif_assurance`;
...
ALTER TABLE `settings` ADD `live_appointment_type` VARCHAR(100) NOT NULL DEFAULT 'jitsi' AFTER `codec_purchase_code`;
UPDATE `settings` SET `live_appointment_type` = 'jitsi';


ALTER TABLE `payment` ADD `ref` VARCHAR(100) NOT NULL AFTER `code`;